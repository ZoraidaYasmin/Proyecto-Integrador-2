...
$txtfn=(isset($_POST['txtfn']))?$_POST['txtfn']:"";
$txtfi=(isset($_POST['txtfi']))?$_POST['txtfi']:"";
...
switch($accion){
    ...
    case "btnEliminar":
        ...
        header("location: ../Administracion/Mantenimientos/MenuAdmin.php");
    break;
...
$sentencia=$pdo->prepare("select * from personal limit 10");
$sentencia->execute();
        ...
        <div class="modal-dialog">
            ...
            <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="txtfn" required value="<?php echo $txtfn;?>" placeholder="" id="txtfn" requiere="">
                            <br>
                        </div>

                        <div class="form-group col-md-6">
                            <label for="">Fecha Ingreso:</label>
                            <input type="text" class="form-control" name="txtfi" required value="<?php echo $txtfi;?>" placeholder="" id="txtfi" requiere="">
                            <br>
                        </div>
