...
$(function () {
    ...
    function validate() {
        try {
            ...
            if (!GeneralFunctions.validateEmail($('#Compañia-email').val())) {
                $('#Compañia-email').closest('.form-group').addClass('has-error');
                throw new Error('The email address is invalid!');
            }
    ...
    /**
     * Get the Compañia data as an object.
     *
     * @return {Object}
     */
    function getCompañiaData() {
        return {
            Compañia_name: $('#Compañia-name').val(),
            Compañia_email: $('#Compañia-email').val(),
            Compañia_link: $('#Compañia-link').val()
        };
    }
