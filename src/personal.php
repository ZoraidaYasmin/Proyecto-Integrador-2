...
class Personal{
    ...
    public function buscar($tabla,$condicion){
        ...
        $consulta="SELECT * FROM ".$tabla." where id_personal=".$condicion.";";
        $resu=$this->db->query($consulta);
        while($filas=$resu->FETCHALL(PDO::FETCH_ASSOC)){
            $this->listado[]=$filas;
        }
    ...
    public function actualizar($tabla,$data,$condicion){
        $consult="UPDATE ".$tabla." set ".$data." where id_personal=".$condicion.";";
    ...
    public function eliminar($tabla,$condicion){
        ...
        $consulta="DELETE FROM ".$tabla." WHERE id_personal='".$condicion."';";
